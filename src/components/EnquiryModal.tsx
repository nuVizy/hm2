...
const EnquiryModal = () => {
  ...
  return createPortal(
    ...
    >
      <div className="w-full max-w-2xl rounded-3xl bg-sand text-ink shadow-soft">
        <div className="flex items-center justify-between border-b border-ink/10 px-6 py-5">
          ...
          <button
            type="button"
            onClick={closeModal}
            className="rounded-full border border-ink/10 p-2 transition hover:border-ink/30"
          ...
          {submitted ? (
            <div className="rounded-2xl border border-ink/10 bg-white p-6 text-center">
              ...
              <button
                type="button"
                onClick={closeModal}
                className="mt-6 rounded-full bg-ink px-6 py-2 text-sm font-semibold text-sand"
              >
                Close
              </button>
            </div>
            ...
            <form className="grid gap-4" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="mt-2 w-full rounded-full bg-ink px-6 py-3 text-sm font-semibold text-sand transition hover:bg-charcoal"
              >
                Submit enquiry
              </button>
