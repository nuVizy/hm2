...
const Footer = () => {
  return (
    <footer className="border-t border-white/10 bg-ink/90 py-12">
      <div className="container grid gap-10 md:grid-cols-[2fr_1fr_1fr]">
        <div>
          ...
          <p className="mt-4 text-sm text-sand/70">{site.description}</p>
          <div className="mt-6 grid gap-2 text-sm text-sand/80">
        ...
        <div>
          <p className="text-sm font-semibold text-sand">Follow</p>
          <ul className="mt-4 space-y-2 text-sm text-sand/70">
      ...
      <div className="container mt-10 border-t border-white/10 pt-6 text-xs text-sand/50">
