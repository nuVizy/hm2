        ...
        <div className="container">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {site.team.map((member) => (
              <div key={member.name} className="rounded-3xl border border-white/10 bg-ink/60 p-5">
                ...
                <h3 className="mt-4 text-lg font-semibold text-sand">{member.name}</h3>
                <p className="text-sm text-gold">{member.role}</p>
                <p className="mt-2 text-xs text-sand/70">{member.bio}</p>
              </div>
            ))}
          </div>
        </div>
